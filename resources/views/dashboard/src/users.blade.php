      ...
      >
          <div class="modal-dialog modal-dialog-centered modal-sm">
              <div class="modal-content">
                  ...
                  <div class="modal-body"><span id="user_delete_modal_content">Are you sure you want to delete</span> <span class="text-vela">{{$user->full_name}}</span><span id="questionMark">?</span></div>
