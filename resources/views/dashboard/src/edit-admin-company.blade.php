  ...
  <body>
    <div class="table-container section-style">
        <div style="border-bottom: 1px solid #ddd; margin-bottom: 40px; padding-bottom: 10px">
            <h4 id="form_edit_admin" style="display: inline-block;">Edit Admin</h4>
            <h4 class="text-vela" style="display: inline-block;">{{$user->full_name}}</h4>
        </div>
        <form
            class="row"
            style="row-gap: 20px"
            method="post"
            action="{{route('admins.update.admin',['user'=>$user->id])}}"
