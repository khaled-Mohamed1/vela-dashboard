...
window.onload = function(){
  ...
  if (!localStorage.getItem("vela-dash-lang") || localStorage.getItem("vela-dash-lang") == "en") {
      ...
      document.querySelector('#dash_contact') ? dash_contact.textContent = "الإتصال" : '';
      document.querySelector('#dash_meeting') ? dash_meeting.textContent = "الإجتماع" : '';
      document.querySelector('#dash_admins') ? dash_admins.textContent = "مشرفين الشركات" : '';
      document.querySelector('#dash_employees') ? dash_employees.textContent = "الموظفين" : '';
      document.querySelector('#dash_chats') ? dash_chats.textContent = "المحادثات الفردية" : '';
      document.querySelector('#dash_groups_chats') ? dash_groups_chats.textContent = "المحادثات الجماعية" : '';
